...
export function IconTool(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M14.7 6.3a4 4 0 0 0 5.3 5.3l-8 8a2.5 2.5 0 0 1-3.5-3.5Z" />
      <path d="M6 3v4M4 5h4" />
...
export function IconPaperclip(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M20 11.5 12 19.5a5 5 0 0 1-7-7l8-8a3.4 3.4 0 0 1 4.8 4.8l-8 8a1.8 1.8 0 0 1-2.6-2.6l7-7" />
    </svg>
  );
}
